...
``` shell
# train yolov9 models
python train.py --workers 8 --device 0 --batch 8 --data '\\storage01\Robotica\CME\dataset_cme_v3\Pontas das ferramentas\tools_final\tools\tools.yaml' --img 640 --cfg models/detect/yolov9-s.yaml --weights './weights/yolov9-s.pt' --name yolov9-s --hyp hyp.scratch-high.yaml --min-items 0 --epochs 50 --close-mosaic 15
